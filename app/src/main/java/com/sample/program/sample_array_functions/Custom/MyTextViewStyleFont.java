...
public class MyTextViewStyleFont extends android.support.v7.widget.AppCompatTextView {
    Context context;

    public MyTextViewStyleFont(Context context, AttributeSet attrs, int defStyle) {
    ...
    public MyTextViewStyleFont(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.context = context;
    ...
    public MyTextViewStyleFont(Context context) {
        super(context);
        this.context = context;
        init();
        this.setLinkTextColor(ContextCompat.getColor(context, R.color.delred));
    ...
    public void init() {
        Typeface tf = Typeface.createFromAsset(getContext().getAssets(), "fonts/Font-Bold.ttf");
